# File:    publish.ps1
# Rol:     ArticleSearch - GitHub release publiceren (asset + version.txt)
# Versie:  1.2.0
# Auteur:  Bart Bossuyt
# Run vanuit de repo root (C:\PY\ArticleSearch):  .\publish.ps1
# Vereist: gh (ingelogd) + git
#
# Changes: 1.2.0 - Foutmelding bij ontbrekende installer verwees nog naar
#                   de oude bestandsnaam "build_installer15.bat" — nu
#                   "build_installer.bat" (dat script is hernoemd, zie
#                   build_installer.bat v1.4.0 en build_and_publish.ps1
#                   v1.2.0). Repo-root-commentaar bijgewerkt naar
#                   C:\PY\ArticleSearch. Geen functionele wijziging aan
#                   de publish-logica zelf.
# Changes: 1.1.0 - BUGFIX: 'git push' aan het einde gaf geen foutmelding
#                   meer bij een mislukte push (bv. non-fast-forward),
#                   waardoor version.py/releases/latest/version.txt lokaal
#                   gecommit bleven maar nooit naar GitHub gepusht werden -
#                   terwijl de Release + het asset (via 'gh', los van git
#                   push) wél online kwamen. Resultaat: de Release zag er
#                   compleet uit op GitHub, maar de app bleef de oude
#                   versie zien (leest version.txt via
#                   raw.githubusercontent.com, niet de GitHub Release
#                   zelf). Nu wordt de exitcode van 'git push' expliciet
#                   gecontroleerd, met een duidelijke foutmelding.
# Changes: 1.0.0 - Baseline. Naar Networkmap-patroon: locatie wordt
#                   DYNAMISCH bepaald via $MyInvocation i.p.v. een
#                   hardgecodeerd pad. Vervangt publish_and_update.ps1/.bat
#                   volledig.
